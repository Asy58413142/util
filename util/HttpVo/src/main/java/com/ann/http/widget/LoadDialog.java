...
public class LoadDialog extends Dialog {
    ...
    private static ProgressWheel progress_wheel;
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            if (canNotCancel && loadDialog!=null) {
                loadDialog.dismiss();
                return true;
            }
        }
